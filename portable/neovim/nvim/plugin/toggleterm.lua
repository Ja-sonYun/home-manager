if require('modules.plugin').mark_as_loaded('toggleterm') then
  return
end
...
vim.api.nvim_create_user_command('ShellClear', function(opts)
  vim.g.shell_opened = 0
  vim.cmd('set laststatus=2')
end, {})

vim.api.nvim_create_user_command('FocusShell', function(opts)
  focus_shell()
end, {})
